...
const PersonalApparel = () => {
	return (
		<div className='container mx-auto my-20'>
			<div className='text-center'>
				<h1 className='text-3xl font-bold'>Professional or Personal Apparel</h1>
				<p className='text-lg font-thin'>
					Create uniforms, promotional merch, or customize your spring style
				</p>
			</div>
...
export default PersonalApparel;
